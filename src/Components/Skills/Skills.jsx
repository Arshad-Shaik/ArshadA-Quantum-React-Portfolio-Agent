...
//       <h2 className='text-3xl sm:text-4xl font-extrabold text-[white]' style={{
//               textShadow: "0 0 10px rgba(255, 255, 255, 0.8)", }}>SKILLS</h2>
//       <div className='w-24 h-1 bg-[#00FF00] mx-auto mt-2'></div>
//       <p className='text-[#ffffff] mt-4 text-lg md:text-2xl lg:text-3xl font-semibold' style={{
...
//         <div key={category.title} className='bg-[#fff] backdrop-blur-md px-6 sm:px-10 py-8 sm:py-6 mb-10 w-full sm:w-[48%] rounded-2xl border-[#00FF00] border-3 shadow-[0_0_20px_1px_rgba(130,69,236,0.3)]'>
//           <h3 className='text-2xl sm:text-3xl font-semibold text-[#000]  mb-4 text-center' style={{
//               textShadow: "0 0 10px rgba(255, 255, 255, 0.8)", }}>
//             {category.title}
//           </h3>

//           {/* Skill Items - 3 per row on larger screens */}
//           <Tilt key={category.title} tiltMaxAngleX={50}
//             tiltMaxAngleY={50} perspective={1000} scale={1.05} hover:scale={2.50}
//             transitionSpeed={1000} gyroscope={true}>

//             <div className='grid grid-cols-2 sm:grid-cols-3 gap-3 w-full'>
//               {category.skills.map((skill) => (
//                 <div key={skill.name}
//                   className='flex items-center justify-center space-x-2 bg-transparent border-2 border-[#00FF00] hover:border-[red] rounded-3xl py-2 px-2 sm:py-2 sm:px-2 text-center'>
//                   <img src={skill.logo} alt={`${skill.name} logo`} className='w-6 h-6 sm:w-8 sm:h-8' />
//                   <span className='text-xs sm:text-sm text-[#000]'>
//                     {skill.name}
//                   </span>
//                 </div>
//               ))}
...
// //                   <div
// //                     key={skill.name}
// //                     onMouseEnter={() => speakSkillName(skill.name)} // ✅ Voice on hover
// //                     className='flex items-center justify-center space-x-2 bg-transparent border-2 border-[#00FF00] hover:border-[red] rounded-3xl py-2 px-2 sm:py-2 sm:px-2 text-center'>
// //                     <img src={skill.logo} alt={`${skill.name} logo`} className='w-6 h-6 sm:w-8 sm:h-8' />
// //                     <span className='text-xs sm:text-sm text-[#000]'>
// //                       {skill.name}
...
//   // Skills data organized in cube structure
//   const cubeFaces = {
//     front: {
...
//   // Counterclockwise rotation animation (Desktop only)
//   useEffect(() => {
...
//   return (
//     <section id="skills" className='py-20 px-4 md:px-8 font-sans bg-black min-h-screen flex flex-col items-center justify-center relative overflow-hidden'>
      
//       {/* Section Title */}
//       <div className='text-center mb-12 w-full'>
//         <h2 className='text-4xl sm:text-5xl font-extrabold text-white mb-4' style={{
//           textShadow: "0 0 20px rgba(255, 255, 255, 0.9)",
//         }}>SKILLS</h2>
//         <div className='w-32 h-1 bg-[#00FF00] mx-auto mb-4' style={{
//           boxShadow: "0 0 20px #00FF00, 0 0 40px #00FF00"
//         }}></div>
//         <p className='text-white text-lg md:text-xl lg:text-2xl font-semibold max-w-2xl mx-auto px-4' style={{
...
//               {/* Front Face */}
//               <div 
//                 className="cube-face cube-face-front absolute w-full h-full bg-black/70 backdrop-blur-lg border-2 border-[#00FF00] rounded-lg flex flex-col items-center justify-center p-4"
//                 style={{ 
...
//                       className="flex items-center space-x-2 bg-black/50 border border-[#00FF00]/40 rounded-lg p-2 hover:bg-[#00FF00]/20 transition-all duration-300 cursor-pointer"
//                     >
//                       <img 
//                         src={skill.logo} 
//                         alt={skill.name} 
...
//               {/* Left Face */}
//               <div 
//                 className="cube-face cube-face-left absolute w-full h-full bg-black/70 backdrop-blur-lg border-2 border-[#FF00FF] rounded-lg flex flex-col items-center justify-center p-4"
//                 style={{ 
//                   transform: 'rotateY(-90deg) translateZ(150px)',
//                   color: '#FF00FF',
...
//                       key={index}
//                       onMouseEnter={() => speakSkillName(skill.name)}
//                       className="flex items-center space-x-2 bg-black/50 border border-[#FF00FF]/40 rounded-lg p-2 hover:bg-[#FF00FF]/20 transition-all duration-300 cursor-pointer"
//                     >
//                       <img 
//                         src={skill.logo} 
//                         alt={skill.name} 
