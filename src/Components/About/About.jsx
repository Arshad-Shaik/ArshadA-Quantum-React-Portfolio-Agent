...
//           </h3>
//           <p
//             className="text-base sm:text-lg md:text-lg text-white mb-10 mt-8 leading-relaxed text-justify"
//             style={{
//               textShadow: "0 0 10px rgba(255, 255, 255, 0.8)", // white-glow
//             }}
//           >
//             As a passionate Full Stack Developer and Data Analyst, I specialize
//             in building responsive, data-driven applications using Python, Java,
//             SQL, MongoDB, and cloud platforms. Proficient in Machine Learning,
//             Deep Learning, and statistical modeling, I thrive in dynamic,
//             collaborative environments focused on scalable, innovative
//             solutions.
//           </p>

//           <a
//             href="/CV/ArshadA.pdf"
//             download="ArshadA.pdf"
...
//               className="w-full ml-[1px] h-full rounded-full object-cover drop-shadow-[0_10px_20px_rgba(130,69,236,0.5)]"
//             />
//           </Tilt>
//         </div>
//       </div>
...
// import Tilt from "react-parallax-tilt";
// import profileImage from "../../assets/hero/CuteBoy.png";
// import secondprofileImage from "../../assets/hero/AA.png"; // ✅ Fixed path
...
//         {/* Left Side */}
//         <div className="md:w-1/2 text-center md:text-left mt-8 md:mt-0">
//           <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-2 leading-tight" style={{
//               textShadow: "0 0 10px rgba(255, 255, 255, 0.8)",
//             }}>
//             Hi, I am 👋🏻 🤩
//           </h1>
//           <h2 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-4 leading-tight" style={{
//               textShadow: "0 0 10px rgba(255, 255, 255, 0.8)",
//             }}>
//             Arshad Wasib Shaik
//           </h2>
...
//               textShadow: "0 0 10px rgba(255, 255, 255, 0.8)",
//             }}>I am a </span>
//             <span className="text-[#00ff00]" style={{
//               textShadow: "0 0 10px rgba(255, 255, 255, 0.8)",
//             }}>
//               <Typewriter
//                 words={[
...
// sample testing must be remove after testing success
...
//   // 🔁 Load and set a female voice when voices are available
//   useEffect(() => {
//     const loadVoices = () => {
...
//         voice.name.toLowerCase().includes("zira") // fallback (Microsoft Zira is female on Windows)
//       );
//       if (selected) setFemaleVoice(selected);
//     };

//     // Call once and again when voices load
//     loadVoices();
//     window.speechSynthesis.onvoiceschanged = loadVoices;
//   }, []);

//   const handleDownloadClick = () => {
//     const msg = new SpeechSynthesisUtterance("Downloading, Arshad Shaik, CV, in your local system, please choose, your path");
//     if (femaleVoice) {
...
//     speak("Downloading, Arshad Shaik, CV, in your local system, please choose, your path");
