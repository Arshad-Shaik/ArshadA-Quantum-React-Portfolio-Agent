...
//             {/* Content Section */}
//             <div className={`w-full sm:max-w-md p-4 sm:p-8 rounded-2xl border border-[#00FF00] bg-[#0000] backdrop-blur-md shadow-[0_0_20px_1px_rgba(130,69,236,0.3)] ${index % 2 === 0 ? "sm:ml-0" : "sm:mr-0"
...
//                   <div>
//                     <h3 className='text-xl sm:text-xl font-semibold text-white' style={{
//           textShadow: "0 0 10px rgba(255, 255, 255, 0.8)",
//         }}>
//                       {edu.degree}
//                     </h3>
...
//                   </div>
//                   {/* Date at the bottom */}
//                   <p className='text-sm text-[#fff] mt-2'>{edu.date}</p>
//                 </div>
//               </div>
//               <p className='mt-4 text-[#fff] font-bold' style={{
//           textShadow: "0 0 10px rgba(255, 255, 255, 0.8)",
//         }}>Grade: {edu.grade}</p>
//               <p className='mt-4 text-[#00FF00] text-justify'>{edu.desc}</p>
//             </div>
//           </div>
//         ))}
//       </div>
...
//             {/* Content Section */}
//             <div className={`w-full sm:max-w-md p-4 sm:p-8 rounded-2xl border hover:border-[#00FF00] bg-[#0000] backdrop-blur-md hover:shadow-[0_0_30px_2px_rgba(0,255,0,0.3)] ${index % 2 === 0 ? "sm:ml-0" : "sm:mr-0"
//               } sm:ml-44 sm:mr-44 ml-8 transform transition-transform duration-300 hover:scale-105`}
//               onMouseEnter={() => speakEducation(edu.degree, edu.school, edu.desc)} // ✅ Voice on hover
