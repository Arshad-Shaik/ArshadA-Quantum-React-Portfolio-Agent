// // Footer.jsx - UPDATED PERFECT VERSION
...
//       icon: <FaLinkedin />, 
//       label: "LinkedIn", 
//       url: "https://linkedin.com/in/arshad-wasib-shaik", 
//       color: "#0077B5" 
//     },
//     { 
//       icon: <FaGithub />, 
//       label: "GitHub", 
//       url: "https://github.com/arshad-wasib-shaik", 
//       color: "#ffffff" 
//     }
//   ];
...
//       icon: '📧',
//       label: 'Email',
//       description: 'arshad.wasib@example.com'
//     },
//     {
//       id: 'projects',
//       icon: '🚀',
...
//       icon: '💬',
//       label: 'Dev Quote',
//       description: quotes[activeQuote].author
//     },
//     {
//       id: 'theme',
//       icon: theme === 'dark' ? '☀️' : '🌙',
...
//   // Custom rotation logic - YOUR QUOTE always appears after dev quotes
//   const rotateQuotes = () => {
//     setActiveQuote((prev) => {
//       // If current is dev quote, go to next dev quote
//       if (quotes[prev].type === "dev") {
//         const nextIndex = (prev + 1) % quotes.length;
//         // Skip to your quote if next is also dev and we've shown enough
//         if (quotes[nextIndex].type === "dev" && Math.random() > 0.7) {
//           return quotes.findIndex(q => q.type === "personal");
//         }
//         return nextIndex;
//       }
//       // If current is your quote, go to dev quote
//       return quotes.findIndex(q => q.type === "dev");
//     });
//   };

//   // Initialize time and visitor count
//   useEffect(() => {
...
//         setTimeout(() => {
//           window.open(socialLinks[1].url, '_blank');
//         }, 100);
//         break;
...
//         navigator.clipboard.writeText('arshad.wasib@example.com');
//         setCopiedEmail(true);
...
//       case 'quote':
//         // Manually rotate quote
//         rotateQuotes();
//         break;
//     }
    
//     // Reset active icon after 1 second
...
//             <span className="counter-number">{visitorCount}</span>
//             <span className="counter-label">Quantum Views</span>
//           </div>
//         </div>
...
//             <motion.div
//               key={item.id}
//               className={`dock-icon-container ${activeIcon === item.id ? 'active' : ''}`}
//               whileHover={{ y: -10 }}
//               whileTap={{ scale: 0.9 }}
...
//         {/* Social Quicklinks - ONLY LinkedIn & GitHub */}
...
//             scrollbar-color: rgba(0, 170, 255, 0.6) transparent;
//           }
          
//           .cosmic-dock::-webkit-scrollbar {
//             height: 6px;
//           }
          
//           .cosmic-dock::-webkit-scrollbar-track {
//             background: rgba(255, 255, 255, 0.1);
//             border-radius: 3px;
//           }
          
//           .cosmic-dock::-webkit-scrollbar-thumb {
//             background: linear-gradient(90deg, #00aaff, #6b46c1);
//             border-radius: 3px;
//           }
//         }
